...
namespace StudioNeoV2
{
    public class OICharInfo : ObjectInfo
    {
        ...
        public override void Save(BinaryWriter _writer, Version _version)
        {
            ...
            int num1 = this.dicAccessGroup != null ? this.dicAccessGroup.Count : 0;
            _writer.Write(num1);
            if (num1 != 0)
            {
            ...
            int num2 = this.dicAccessNo != null ? this.dicAccessNo.Count : 0;
            _writer.Write(num2);
            if (num2 == 0)
                return;
        ...
        public override void Load(BinaryReader _reader, Version _version, bool _import, bool _tree = true)
        {
            ...
            {
                int index2 = _reader.ReadInt32();
                this.ikTarget[index2] = new OIIKTargetInfo(!_import ? -1 : Studio.GetNewIndex());
            ...
            if (this.lookAtTarget == null)
                this.lookAtTarget = new LookAtTargetInfo(!_import ? -1 : Studio.GetNewIndex());
        ...
        public OICharInfo(ChaFileControl _charFile, int _key)
          : base(_key)
        {
            this.sex = _charFile != null ? _charFile.parameter.sex : 0;
            ...
            foreach (int index in Info.Instance.AccessoryPointsIndex)
