...
namespace StudioKK
{
    public class OICharInfo : ObjectInfo
    {
        ...
        public OICharInfo(ChaFileControl _charFile, int _key)
          : base(_key)
        {
            this.sex = _charFile == null ? 0 : _charFile.parameter.sex;
            ...
            int accessoryPointNum = Info.Instance.accessoryPointNum;
            for (int index = 0; index < accessoryPointNum; ++index)
        ...
        public override void Load(BinaryReader _reader, Version _version, bool _import, bool _tree = true)
        {
            ...
            int num4 = _version.CompareTo(new Version(0, 0, 9)) < 0 ? 4 : 8;
