...
namespace StudioNeo
{
    public class CameraControl
    {
        public class CameraData
        {
            ...
            public virtual void Set(Vector3 _pos, Vector3 _rotate, Vector3 _distance, float _parse)
            {
                this.pos = _pos;
                this.rotate = _rotate;
            ...
            public virtual void Load(BinaryReader _reader)
            {
            ...
            public virtual void Copy(CameraData _src)
            {
                this.pos = _src.pos;
