    ...
    public class CharFileInfoPreview : BlockControlBase
    {
        ...
        public void Update(CharFile chaFile)
        {
            ...
            else
            {
                ...
                float num1 = chaFile.customInfo.shapeValueBody[0];
                this.height = num1 >= 0.330000013113022 ? (num1 <= 0.660000026226044 ? 1 : 2) : 0;
                float num2 = chaFile.customInfo.shapeValueBody[1];
                this.bustSize = num2 >= 0.330000013113022 ? (num2 <= 0.660000026226044 ? 1 : 2) : 0;
